...
public class KarafGenerator extends BaseGenerator {
    ...
    private static final String IMAGE_S2I_UPSTREAM_VERSION = getBuildSetting("karaf.upstream.s2i.image.version");
    private static final String IMAGE_S2I_PRODUCT_VERSION = getBuildSetting("karaf.product.s2i.image.version");
