...
WARNING: This document is work-in-progress. The most matured chaptervs are the <<introduction>>, the description of the <<fabric8:buidld>> goal and the <<generators,Generator>> chapter is growing constantly.
