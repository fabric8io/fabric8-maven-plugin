...
* The following annotations:
  ...
  - `discovery.3scale.net/path`: the contextPath of the service if it's not at the root.
  - `discovery.3scale.net/port`: the contextPath of the service if it's not at the root.
