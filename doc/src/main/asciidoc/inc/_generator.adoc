...
You can easily create your own generator as explained in <<building-generators, Creating Generators>>. This section however will focus on existing generators and how you can configure them.
