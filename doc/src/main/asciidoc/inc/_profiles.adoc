...
| *aggregate*
| Includes no generators and only the <<fmp-dependency,fmp-dependency>> enricher for picking up and combining resources from the compile time dependencies.

| *internal-microsercice*
...
[source, yaml]
----
include::{plugindir}/src/main/resources/META-INF/fabric8/profiles-default.yml[tags=default]
----
